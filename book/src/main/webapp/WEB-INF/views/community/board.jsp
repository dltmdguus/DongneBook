...
function page(n){
	...
	location.href="./board?board="+${param.board}+"&pageNo="+pageNo;
	}else{
	location.href="./board?board=${param.board}&pageNo="+pageNo+"&searchN=${param.searchN}&searchV=${param.searchV}";
	}
}
function login(){
       ...
       <hr class="divider-w">
          <div class="container" style="width: 100%; margin-bottom: 50px; margin-top:50px;">
           ...
           <!--  옆 메뉴바  -->
            ...
            <div class="container">
            	 ...
            	 <c:when test="${param.board eq 2 }"><img src="../board/독후감.jpg" style="width: 600px;  height : 300px" class="rounded"></c:when>
              ...
              <div class="first">
               	...
               	<c:choose><c:when test="${sessionScope.mid ne null}"><button type="button" class ="btn btn-border-d btn-round firstb" onclick="location.href='./bwrite?board=${param.board}'">글쓰기</button> &nbsp; &nbsp;</c:when>
               	<c:otherwise><button type="button"  class ="btn btn-border-d btn-round firstb" onclick="login()">글쓰기</button>&nbsp; &nbsp; </c:otherwise>
               </c:choose><c:forEach items="${boardList }" var="l"><il><a href="${l.surl }">${l.stitle }</a></il> &nbsp; &nbsp; </c:forEach> <il><a href="./">전체</a></il>
         ...
         <!--   검색창  -->
               ...
               <tr class="row detail" onclick="location.href='./bdetail?board=${param.board}&bno=${row.bno}'">
               		<td class="col-7 title">${row.btitle }&nbsp; <c:if test="${row.commentcount  ne 0}"><img src="../board/댓글.png" style="width: 10px;  height : 10px" class="rounded"> ${row.commentcount} </c:if></td>
