    ...
    <main>
       ...
       <hr class="divider-w">
          <div class="container" style="width: 100%; margin-bottom: 50px; margin-top:120px;">
 			<!--  옆 메뉴바  -->
 			<div class="col-sm-1 col-md-1 sidebar " style= "margin-top:250px;">
               <div class="widget">
           ...
           <!--  옆 메뉴바  -->
             ...
             <div class="col-sm-8 col-sm-offset-1">
            	 ...
            	 <c:choose>
            	 <c:when test="${param.board eq 1 }"><img src="../board/공지사항.png" style="width: 500px;  height : 200px"></c:when>
            	 <c:when test="${param.board eq 2 }"><img src="../board/qna.png" style="width: 500px;  height : 200px"></c:when>
            	 <c:when test="${param.board eq 3 }"><img src="../board/문의.png" style="width: 500px;  height : 200px"></c:when>
            	 </c:choose>
            	 </div>
                  <div class="post-header font-alt">
                    <h1 class="post-title">${ndetail.ntitle}</h1>
                    <div class="post-meta">By&nbsp;${ndetail.mid }| ${ndetail.ndate }| ${ndetail.nno } |  <a href="notice?board=${ndetail.ncate}">${ndetail.nstitle} </a>|&nbsp;<a href="#"></a>
						<c:if test="${sessionScope.mid eq ndetail.mid && ndetail.nreply == 0 }" ><button onclick="nedit()">수정하기</button></c:if><c:if test="${sessionScope.mid eq ndetail.mid ||  sessionScope.mgrade eq 2}"><button onclick="del()">삭제하기</button></c:if></div>
                    </div>
