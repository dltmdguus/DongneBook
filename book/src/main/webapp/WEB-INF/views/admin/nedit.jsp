 ...
 #title{
  ...
  <body data-spy="scroll" data-target=".onpage-navigation"
	...
	<main>
       ...
       <hr class="divider-w">
          <div class="container">
            	<form action="./nedit" method="post"  onsubmit="return nedit(${detail.nno })">
					<input type="text" name="title" id="title" value="${detail.ntitle }">
					<div id="editor">${detail.ncontent }</div>
					<input type="hidden" id="quill_html" name="content">
					<input type="hidden" name="nno" value="${detail.nno }">
					<input type="hidden" name="cate" value="${cate }">
					<input type="hidden" name="page" value="${page }">
					<button type="submit" class="nedit btn" >수정</button>
				</form>
          </div>
