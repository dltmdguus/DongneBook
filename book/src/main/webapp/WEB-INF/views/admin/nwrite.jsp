 ...
 #title{
  ...
  <body data-spy="scroll" data-target=".onpage-navigation"
	...
	<main>
       ...
       <hr class="divider-w">
          <div class="container">
            	<form action="./nwrite" method="post"  onsubmit="return nwrite()">
            			<span class="col-sm-3 mb-sm-20">
							<select class="form-control" name="cate" id="cate" required="required">
					...
					<button type="submit" class="nedit btn" >글쓰기</button>
				</form>
          </div>
